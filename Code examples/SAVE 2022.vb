Public Sub Save()
    ...
    Sheets(Array("ESRP", "ATT MAIL", "MULTI MAIL", "MULTI WRAP", "CANFGNOTHER")).Select
    Sheets("CANFGNOTHER").Activate
    Sheets(Array("ESRP", "ATT MAIL", "MULTI MAIL", "MULTI WRAP", "CANFGNOTHER")).Copy _
